...
<html>
    <head>
        ...
        <title>Admin | Lihat Data Produk</title>
...
<!--                                        <a href="../customerPages/addCustomer.jsp" class="nav-link">
                                    ...
                                    <li class="nav-item">
<!--                                        <a href="addProduk.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Produk</p>
                                        </a>-->
                                    ...
                                    <li class="nav-item">
<!--                                        <a href="matkulPages/addMatkul.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Layanan</p>
                                        </a>-->
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="dataProduk.jsp" class="nav-link active disabled">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Produk</p>
                                        </a>
                                    </li>
        ...
        <div class="content-wrapper pt-3">
            ...
            <section class="content">
                <div class="container-fluid">
                    <h2 class="border-primary border-bottom border-2 pb-4">Data Produk</h2>
                    <table class="table mt-5 border">
                        ...
                        <%
                            ...
                            <tr>
                                    ...
                                    <td> 
                                        <form action="formProduk.jsp?a=u" method="post" class="col-6 float-start">
        <!--                                    <input type='hidden' name='nim' value='"+i+"'/>-->
                                        ...
                                        <form action="formProduk.jsp?a=d" method="post" class="col-6 float-end">
                                            <input type='hidden' name='nim' value='"+i+"'/>
