                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <!--                                        <a href="addProduk.jsp" class="nav-link active disabled">
                                                                                    <i class="far fa-circle nav-icon"></i>
                                                                                    <p>Produk</p>
                                                                                </a>-->

                                        <form action="formProduk.jsp?a=x" method="post">
                                            <input type="hidden" name="action" value="insert"/>
...
<!--                                        <a href="../layananPages/addLayanan.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="dataProduk.jsp" class="nav-link
                                           <% if (request.getParameter("action").toString().equalsIgnoreCase("edit") && request.getParameter("edit-menu").toString().equalsIgnoreCase("produk")) { %>
                                           active disabled
                                           <%  }%> ">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Produk</p>
        ...
        <div class="content-wrapper pt-3">
            ...
            <section class="content ps-4">
                ...
                <div class="w-50">
                    <% if (request.getParameter("a").equalsIgnoreCase("u")) { %>
                        <form class="mt-3" action="../ServletUpdateroduk" method="POST">
                    <%} else if (request.getParameter("a").equalsIgnoreCase("d")) { %>
                        <form class="mt-3" action="../ServletDeleteProduk" method="POST">
                    <% }  else  { %>
                        <form class="mt-3" action="../ServletInsertProduk" method="POST">
                    <% }%>
<!--                        <input type="hidden" name="action" value="insert"/>-->

                        <div class="mb-3">
                            <label for="nama-pet" class="form-label">ID Produk :</label>
                            <input type="text" class="form-control" id="id" name="id" placeholder="ID Produk/Barang" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Produk :</label>
                            <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Produk/Barang">
                        </div>

                        <div class="mb-3">
                            <label for="harga" class="form-label">Harga :</label>
                            <input type="text" class="form-control" id="harga_produk" name="harga" placeholder="Harga Produk/Barang">
                        </div>

                        <div class="mb-3">
                            <label for="stok">Stok :</label>
                            <input type="number" class="form-control" id="stok" name="stok" placeholder="Jumlah Stok Produk/Barang">
                        </div>
