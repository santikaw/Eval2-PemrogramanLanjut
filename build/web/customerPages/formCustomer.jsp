...
<!--                                        <a href="../layananPages/addLayanan.jsp" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="dataCustomer.jsp" class="nav-link
                                           <% if (request.getParameter("action").toString().equalsIgnoreCase("edit") && request.getParameter("edit-menu").toString().equalsIgnoreCase("customer")) { %>
                                           active disabled
                                           <%  }%> ">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Customer</p>
        ...
        <div class="content-wrapper pt-3">
            ...
            <section class="content ps-4">
                ...
                <div class="w-50">
                    ...
                    <% if (request.getParameter("a").equalsIgnoreCase("u")) { %>
                        <form class="mt-3" action="../ServletUpdateCustomer" method="POST">
                    <%} else if (request.getParameter("a").equalsIgnoreCase("d")) { %>
                        <form class="mt-3" action="../ServletDeleteCustomer" method="POST">
                    <% }  else  { %>
                        <form class="mt-3" action="../ServletInsertCustomer" method="POST">
                    <% }%>
                   
<!--                        <input type="hidden" name="action" value="insert"/>-->
                        
                        <div class="mb-3">
                            <label for="nama-pet" class="form-label">ID Hewan :</label>
                            <input type="text" class="form-control" id="id" name="id" placeholder="ID Hewan Peliharaan" required>
                        </div>
                        
                        <div class="mb-3">
                            <label for="nama-pet" class="form-label">Nama Hewan :</label>
                            <input type="text" class="form-control" id="nama-pet" name="nama_pet" placeholder="Nama Hewan Peliharaan">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ras" name="ras" placeholder="Jenis Ras Hewan Peliharaan">
                        </div>

                        <div class="mb-3">
                            <label for="pemilik" class="form-label">Nama Pemilik :</label>
                            <input type="text" class="form-control" id="pemilik" name="pemilik" placeholder="Nama Lengkap Pemilik">
                        </div>

                        <div class="mb-3">
                            <label for="telp" class="form-label">No. Telepon :</label>
                            <input type="number" class="form-control" id="telp" name="telepon" placeholder="08123456789">
                        </div>              
